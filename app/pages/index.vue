...
<template>
  <section
    class="grid min-h-dvh grid-rows-[2fr_1fr]"
  ...
  >
    ...
    <!-- <div
      ref="container"
      class="grid place-items-end w-full"
    >
      <h1
        ref="text"
        class="inline-block overflow-clip font-fancy leading-[0.8] text-fit whitespace-nowrap uppercase will-change-all"
        :style="[style, { opacity: isReady ? 1 : 0, transition: 'opacity 0.2s ease' }]"
        data-vitals-ignore
      >
        <AnimationLetterByLetter
          :start="isReady"
          text="EBRAHEEM"
          :delay="0.2"
        />
  ...
  <div id="test">
    ...
    dolorem eum fugiat quo voluptas nulla pariatur?" 1914 translation by H. Rackham "But I must
    ...
    resultant pleasure?" Section 1.10.33 of "de Finibus Bonorum et Malorum", written by Cicero in 45
    BC "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium
    ...
    endures pains to avoid worse pains." The standard Lorem Ipsum passage, used since the 1500s
